window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const MODE_TAXONOMY = [
      { id: 'coding', label: '编码', scopes: ['sidebar'], sidebarOrder: 0 },
      { id: 'tavern', label: '酒馆', workspaceLabel: '酒馆桥接', scopes: ['sidebar', 'workspace'], sidebarOrder: 1, workspaceOrder: 5 },
      { id: 'museai', label: 'MuseAI', scopes: ['sidebar', 'workspace'], sidebarOrder: 2, workspaceOrder: 4 },
      { id: 'story', label: 'Story', scopes: ['sidebar', 'workspace'], sidebarOrder: 3, workspaceOrder: 3 },
      { id: 'resources', label: '资源库', scopes: ['workspace'], workspaceOrder: 0 },
      { id: 'cards', label: '卡片工作台', scopes: ['workspace'], workspaceOrder: 1 },
      { id: 'regex', label: '正则预览', scopes: ['workspace'], workspaceOrder: 2 }
    ]
