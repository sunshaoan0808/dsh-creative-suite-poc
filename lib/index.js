      ...
      handler: async (req, res) => {
        ...
        try {
          ...
          if (req.method === 'POST' && pathname === '/plugins/creative-suite/tavern/gameplay/create') {
            ...
            const runtime = createHelperRuntime({ cardId: card.id, rawCard: raw, variables: {}, messages: [], sessionId: '', cardName: card.name || '', userName: String(body.userName || '你') })
          ...
          if (req.method === 'POST' && pathname === '/plugins/creative-suite/tavern/gameplay/send') {
            ...
            let generated
            try {
              generated = await generateTextWithRetry(routeCtx, { system: buildMuseSystem(buildMuseContext(store, { cardId: runtime.cardId }), 'tavern', {}), prompt: input.trim(), maxTokens: 2000 })
            } catch (error) {
